...
async function up() {
  try {
    ...
    await MadarisSubjectCurriculum.init();
    console.log('✅ Created madaris_subject_curriculum collection with indexes');
...
async function down() {
  try {
    ...
    // Drop the collection
    await mongoose.connection.dropCollection('madaris_subject_curriculum');
    console.log('✅ Dropped madaris_subject_curriculum collection');
