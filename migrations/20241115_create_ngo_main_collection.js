...
/**
 * Migration: Create ngo_main collection with indexes
 */
async function up() {
  try {
    // Connect to MongoDB
    ...
    await NGOMain.init();
    console.log('✅ Created ngo_main collection with indexes');
...
/**
 * Rollback: Drop ngo_main collection
 */
async function down() {
  try {
    // Connect to MongoDB
    ...
    // Drop the collection
    await mongoose.connection.dropCollection('ngo_main');
    console.log('✅ Dropped ngo_main collection');
